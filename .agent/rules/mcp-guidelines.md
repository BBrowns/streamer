...
* **Protocol:**
    1.  **Pre-Flight Check:** Use the `git` MCP tool to check status. If the tree is dirty, ask: *"You have uncommitted changes. Should I commit, stash, or create a new branch?"*

        ...
        <View style={styles.container}>
            ...
            <View style={styles.installSection}>
                ...
                <View style={styles.inputRow}>
                    ...
                    />
                    <Pressable
                        style={[styles.installBtn, (!addonUrl || installMutation.isPending) && styles.disabledBtn]}
                            ...
                            <View style={styles.addonCard}>
                                ...
                                <View style={styles.addonInfo}>
                                    ...
                                    <Text style={styles.addonMeta}>
                                        v{item.manifest.version} · {item.manifest.types.join(', ')} · {item.manifest.catalogs.length} catalog(s)
                                    </Text>
                                </View>
                                <Pressable

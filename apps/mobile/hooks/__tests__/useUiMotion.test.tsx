...
describe("useUiMotion", () => {
  it("exposes semantic durations and spatial-motion policy", () => {
    const { result } = renderHook(() => useUiMotion());
  ...
  it("disables spatial and continuous motion while preserving instant state changes", () => {

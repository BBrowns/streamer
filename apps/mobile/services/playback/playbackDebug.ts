...
/**
 * Emits a bounded set of playback boundary events for local diagnostics.
 * Sanitization happens before console output so transient source material and
 * credentials cannot be copied into pasted logs.
 */

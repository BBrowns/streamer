...
| Electron/web dev runtime   | Partial        | Real main/preload smoke passed for build labels, `inspectFile`, and 125%/150% zoom; work-network desktop playback, the latest passed configured torrent probe, and local direct MP4/HLS-origin first-frame coverage are recorded in the [September 16 source-coverage run](./qa-runs/2026-09-16/work-network-source-coverage.md). No packaged playback claim. |
| iOS Simulator              | Partial        | Disposable Expo prebuild and RN 0.86.3/New Architecture build passed; the generated `com.bbrowns.streamer` app installed and launched on iPhone 15. No Metro/API-backed app journey or playback flow ran. See the [August 31 dependency upgrade run](./qa-runs/2026-08-31-dependency-upgrade.md).                                                             |
| iPhone physical device     | Unknown        | No run recorded yet.                                                                                                                                                                                                                                                                                                                                          |
| Android Emulator           | Partial        | Disposable Expo prebuild, `assembleDebug`, and `assembleAndroidTest` passed with New Architecture; the configured ARM64 AVD booted and launched the debug app, but no Detox or playback flow ran. See the [August 31 dependency upgrade run](./qa-runs/2026-08-31-dependency-upgrade.md).                                                                     |
...
| Desktop bridge diagnostics/repair                          | Unknown          | Partial: the latest configured torrent probe passed and bridge contract evidence is recorded in the [September 16 source-coverage run](./qa-runs/2026-09-16/work-network-source-coverage.md). | Unknown | Not run | Unknown                                                   |

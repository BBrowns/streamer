...
| Browser web                | Partial        | Deterministic responsive renderer and recovery flows passed. The reviewed Darwin Home/Settings/Search baseline is recorded, while the Linux CI baseline is being bootstrapped; no real-source first-frame claim. See the [July 15 run](./qa-runs/2026-07-15-adaptive-correctness.md) and [July 18 visual run](./qa-runs/2026-07-18-visual-regression.md). |

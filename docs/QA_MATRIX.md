...
| iOS Simulator              | Partial        | Xcode-selected iOS 26.5 runtime build 23F77 and an iPhone 15 simulator are installed. A disposable Expo prebuild compiled, installed, and launched the Streamer development client; no Metro/API-backed app journey or playback flow ran. See the [July 29 run](./qa-runs/2026-07-29-native-targets-and-stream-disconnect.md). |
| iPhone physical device     | Unknown        | No run recorded yet.                                                                                                                                                                                                                                                                                                           |
| Android Emulator           | Partial        | The API 34 Google APIs ARM64 image and exact configured Detox AVD are installed. `emulator-5554` booted to `sys.boot_completed=1`; no native app build, Detox flow, or playback flow ran. See the [July 29 run](./qa-runs/2026-07-29-native-targets-and-stream-disconnect.md).                                                 |

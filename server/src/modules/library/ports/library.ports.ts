...
export interface ILibraryRepository {
    ...
    findByUserAndItem(userId: string, itemId: string): Promise<LibraryItemRecord | null>;
    create(data: { userId: string; type: string; itemId: string; title: string; poster?: string | null }): Promise<LibraryItemRecord>;

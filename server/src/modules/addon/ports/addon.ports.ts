...
export interface IAddonRepository {
    ...
    findByUserAndUrl(userId: string, transportUrl: string): Promise<AddonRecord | null>;
    findAllByUser(userId: string): Promise<AddonRecord[]>;
    create(data: { userId: string; transportUrl: string; manifest: AddonManifest }): Promise<AddonRecord>;
